...
const files = ['depGraph.ts', 'extension.ts', 'fileWatch.ts', 'metadataScanner.ts', 'orgStore.ts', 'panelHtml.ts', 'panelProvider.ts', 'runRecords.ts', 'sfCliService.ts', 'suggestionLog.ts']
